      ...
      <div className={` flex-col mx-auto items-center overflow-x:hidden ${isDarkMode ? 'bg-black text-white' : 'bg-white text-gray-900'}`} style={{ overflowX: 'hidden' }}>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-6 ">
          <div className="max-w-4xl mx-auto p-8 text-center md:text-left md:pr-8 lg:w-1/2 lg:text-left">
            ...
            <a href="https://drive.google.com/file/d/1rDkAkLgEqWbkAOBbc-xXwnLLznH9GQst/view?usp=sharing" class=" mt-8 px-8 md:px-16 py-4 font-Urbanist font-md bg-gradient-to-r from-blue-500 via-blue-300 to-blue-800 text-white rounded-xl  hover:bg-blue-700 dark:bg-gray-700 transition duration-300 hover:translate-y-px">
              Download CV
            </a>
